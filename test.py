...
class Cell:
    ...
    def show(self):
        ...
        # Draw cell walls
        if self.walls[0]:
            pygame.draw.line(screen, RED, (x, y), (x + w, y), 2)  # Top
        if self.walls[1]:
            pygame.draw.line(screen, RED, (x + w, y), (x + w, y + w), 2)  # Right
        if self.walls[2]:
            pygame.draw.line(screen, RED, (x + w, y + w), (x, y + w), 2)  # Bottom
        if self.walls[3]:
            pygame.draw.line(screen, RED, (x, y + w), (x, y), 2)  # Left
